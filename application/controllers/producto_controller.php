...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Producto_controller extends CI_Controller{
	    ...
	    * Muestra todos los productos en tabla */
		...
		/**
	    * Muestra todas las mascotas en tabla
	    */
		function muestra_mascotas()
		{
			if($this->_veri_log()){
			...
			$this->load->view('productos/muestra_mascotas', $dat);
			$this->load->view('front/footer_view');
			}else{
			redirect('login', 'refresh'); }
		}
		...
		/**
	    * Muestra todos los accesorios en tabla
	    */
		function muestra_accesorios()
		{
			...
			$this->load->view('front/head_view', $data);
			$this->load->view('front/navbar_view');
			$this->load->view('productos/muestra_accesorios', $dat);
			$this->load->view('front/footer_view');
			}else{
			redirect('login', 'refresh'); }
		}
 	...
 	function listar_ventas()
	    { 
			...
			$dat = array('venta' => $this->producto_model->get_ventas_cabecera());

			$this->load->view('front/head_view',$data);
			$this->load->view('front/navbar_view',$data);
			$this->load->view('usuarios/muestraventas',$dat);
			$this->load->view('front/footer_view');
            }else{
			redirect('login', 'refresh');
            }
        ...
        function muestra_detalle($id_vent)
		{
             if($this->_veri_log()){
			...
			$dat = array('cart' => $this->producto_model->get_ventas_detalle($id_vent));
